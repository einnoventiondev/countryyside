...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.requestForm.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.request-forms.update", [$requestForm->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                @foreach(App\Models\RequestForm::BASIC_INFORMATION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('basic_information') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="basic_information_{{ $key }}" name="basic_information" value="{{ $key }}" {{ old('basic_information', $requestForm->basic_information) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $requestForm->first_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $requestForm->last_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $requestForm->city) }}">
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $requestForm->phone) }}">
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $requestForm->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\RequestForm::ADDITIONAL_DETAILS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('additional_details') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="additional_details_{{ $key }}" name="additional_details" value="{{ $key }}" {{ old('additional_details', $requestForm->additional_details) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\RequestForm::BOOK_YOUR_APPOINTMENT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('book_your_appointment') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="book_your_appointment_{{ $key }}" name="book_your_appointment" value="{{ $key }}" {{ old('book_your_appointment', $requestForm->book_your_appointment) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('text') ? 'is-invalid' : '' }}" name="text" id="text">{!! old('text', $requestForm->text) !!}</textarea>
                @if($errors->has('text'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $requestForm->date) }}">
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('time') ? 'is-invalid' : '' }}" type="text" name="time" id="time" value="{{ old('time', $requestForm->time) }}">
                @if($errors->has('time'))
