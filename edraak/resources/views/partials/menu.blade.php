    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('request_form_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.request-forms.index") }}" class="nav-link {{ request()->is("admin/request-forms") || request()->is("admin/request-forms/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-allergies">

                            </i>
                            <p>
                                {{ trans('cruds.requestForm.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
